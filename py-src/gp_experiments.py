...
if __name__ == "__main__":
    ...
    parser.add_argument('--n_train_list', type=list, nargs='+', default=[50, 100, 200, 400, 800])
    ...
    parser.add_argument('--s_factors_percs', type=list, nargs='+', default=np.arange(.5, 1, .01))
